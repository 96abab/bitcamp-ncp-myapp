...
function getStudent(e) {
  ...
  fetch("../students/" + no)
    ...
    .then((result) => {
      ...
      if (student.photo)
       document.querySelector("#f-photo-origin").href = "https://kr.object.ncloudstorage.com/bitcamp-bucket14-member-photo/${student.photo}";
       document.querySelector("#f-photo").src = "미리보기 url";
